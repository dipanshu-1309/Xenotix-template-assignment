    ...
    <div className={styles['frame-15']}>
      ...
      <div className={styles['group-148']}>
        <div className={styles['long-text']}>
          Unlock a world of possibilities for your brand. Our Streamlined approach ensures that you can maximize your Online Presence.
        </div>
        <div className={styles['box-1']}>
          <img src="/assets/images/Vector-7.png" alt="vector7" className={styles['vector-7']} />
          <div className={styles['box-text']}>Social</div>
        </div>
      </div>

      <div className={styles['rectangle-43']}>
        <img src="/assets/images/Vector-7.png" alt="vector7" className={styles['vector-7']} style={{ left: '2.6px', top: '4.3px' }} />
        <div className={styles['box-text']} style={{ left: '13px', top: '3.3px' }}>Creatives</div>
      </div>

      <div className={styles['rectangle-44']}>
        <img src="/assets/images/Vector-7.png" alt="vector7" className={styles['vector-7']} style={{ top: '4.3px' }} />
      ...
      <img src="/assets/images/Ellipse50.png" alt="ellipse50" className={styles['shape-1']} />
    </div>
  );
};
